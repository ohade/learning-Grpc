...
public class ThirdClient {
    ...
    private ThirdServiceBlockingStub blockingStub2;
    ...
    public ThirdClient(int port) {
        ...
        channel2 = ManagedChannelBuilder.forAddress("localhost", port+1).usePlaintext(true).build();
        blockingStub2 = newBlockingStub(channel2);
    }
